...
import com.pichincha.chapter.evaluacion.login.domain.User;
...
public class ApplicationConfiguration {
    ...
    public AuthenticationProvider authenticationProvider(){
        ...
        authenticationProvider.setPasswordEncoder(passworEncoded());
        return authenticationProvider;
    }

    @Bean
    public PasswordEncoder passworEncoded() {
